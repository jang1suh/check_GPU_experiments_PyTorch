...
class CIFAR100_Resnet18(torch.nn.Module):
    def __init__(self):
...
class CIFAR100_Resnet34(torch.nn.Module):
    def __init__(self):
        super(CIFAR100_Resnet34, self).__init__()
        self.model = torch.hub.load(
            "pytorch/vision:v0.6.0",
            "resnet34",
            pretrained=False,
...
class CIFAR100_Resnet50(torch.nn.Module):
    def __init__(self):
...
class CIFAR100_Resnet101(torch.nn.Module):
    def __init__(self):
        super(CIFAR100_Resnet101, self).__init__()
        self.model = torch.hub.load(
            "pytorch/vision:v0.6.0",
            "resnet101",
            pretrained=False,
...
class CIFAR100_Resnet152(torch.nn.Module):
    def __init__(self):
        super(CIFAR100_Resnet152, self).__init__()
        self.model = torch.hub.load(
            "pytorch/vision:v0.6.0",
            "resnet152",
            pretrained=False,
...
def main():
    parser = argparse.ArgumentParser(description='PyTorch CIFAR100 sample experiment')
    ...
    train_set = datasets.CIFAR100('./data', train=True, download=True,
                       transform=transform)
    test_set = datasets.CIFAR100('./data', train=False,
                       transform=transform)
...
MODEL_MAP = {
    "cnn1": CNN1,
    "resnet18": CIFAR100_Resnet18,
    "resnet34": CIFAR100_Resnet34,
    "resnet50": CIFAR100_Resnet50,
    "resnet101": CIFAR100_Resnet101,
    "resnet152": CIFAR100_Resnet152,
}
